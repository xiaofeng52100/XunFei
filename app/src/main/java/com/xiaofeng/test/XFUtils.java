...
import com.xiaofeng.test.util.JsonParser;
...
public class XFUtils extends LinearLayout {
    ...
    public XFUtils(@Nullable Context context) {
        super(context);
        initializeViews(context);
    }

    public XFUtils(@Nullable Context context, AttributeSet attrs) {
        super(context, attrs);
        initializeViews(context);
    }
